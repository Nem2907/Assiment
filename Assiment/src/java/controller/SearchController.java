...
public class SearchController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String filter = request.getParameter("filter").trim().toLowerCase();
            ...
            if ("price".equals(filter)) {
                ...
                result = pdao.searchByPrice(price);
            } else {
                result = pdao.search(keyword);
            }
            ...
            //gửi keyword và filtercho thanh tìm kiếm lưu:
